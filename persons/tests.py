...
class UrlTest(APITestCase):
    ...
    def test_people_can_register(self):
    ...
    def test_people_cant_register_without_confirmation(self):
        r_register = self.client.post('/api/v1/persons/register', data={
                                      "username": "test2",
                                      "email": "test@test.test",
                                      "password": "test1234",
    ...
    def test_people_can_change_password(self):
    ...
    def test_people_cant_change_password_without_confirmation(self):
        self.__jwt_auth(self.person)
        r_change_pass = self.client.patch("/api/v1/persons/changePassword", data={"old_password": "test1234",
                                                                                  "password": "test12345",
    ...
    def test_people_cant_change_password_without_old_password(self):
        self.__jwt_auth(self.person)
